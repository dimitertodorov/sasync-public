module Sasync::SymmetricEncryption
  ...
  class Reader
    ...
    # Sasync::SymmetricEncryption::Reader.open('test_file') do |file|
    #   file.each_line {|line| p line }
    # end
    #
    # # Example: Read and decrypt entire file in memory
    # # Not recommended for large files
    # Sasync::SymmetricEncryption::Reader.open('test_file') {|f| f.read }
    #
    ...
    # Sasync::SymmetricEncryption::Reader.open('encrypted_compressed.zip', :compress => true) do |file|
    #   file.each_line {|line| p line }
    # end
    #
    ...
    # require 'fastercsv'
    # begin
    #   csv = FasterCSV.new(Sasync::SymmetricEncryption::Reader.open('csv_encrypted'))
    #   csv.each {|row| p row}
    # ensure
    #   csv.close if csv
    # end
    ...
    #       To decompress the data automatically call Sasync::SymmetricEncryption.open
    def compressed?
      @compressed
    end
    ...
    def read_header
      ...
      @cipher = Sasync::SymmetricEncryption.cipher(@version)
      raise "Cipher with version:#{@version.inspect} not found in any of the configured Sasync::SymmetricEncryption ciphers" unless @cipher
